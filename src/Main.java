...
public class Main {
    public static void main(String[] args) {
        ...
        employeeData.addEmployee("Еремин Александр Никитич", "4",15);
        ...
        employeeData.printAllEmployees();//список Ф.И.О
        System.out.println();
        ...
        employeeData.removeEmployee("Савин Артемий Елисеевич");
        employeeData.findEmployee("Савин Артемий Елисеевич");

        employeeData.addEmployee("Крылова Вера Данииловна", "2",2);
        employeeData.addEmployee("Игумнов Алексей Николаевич", "2",28);
        System.out.println();
        System.out.println("Количество сотрудников: " + EmployeeData.getCurrentSize());
        System.out.println(employeeData);
